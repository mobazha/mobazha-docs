...
- [RFC-0014：报价绑定的跨币种 Payment Attempt 授权](https://github.com/mobazha/mobazha-docs/blob/main/rfcs/0014-quote-bound-cross-currency-payment-attempt-authorization.md) — Draft；规定买家提出不可执行的资金依据，卖家用本地新鲜汇率下限校验，并在 attempt 结算条款中签署其精确哈希后才完成授权。
