...
- [RFC-0010: Guest Checkout Trust and Custody Model](https://github.com/mobazha/mobazha-docs/blob/main/rfcs/0010-guest-checkout-trust-and-custody.md) — Draft; proposes the custodial direct-payment trust contract, per-chain capability gate, anonymous buyer identity, and disclosure rules for Guest Checkout.
