...
- [RFC-0014: Quote-bound Cross-currency Payment Attempt Authorization](https://github.com/mobazha/mobazha-docs/blob/main/rfcs/0014-quote-bound-cross-currency-payment-attempt-authorization.md) — Draft; proposes binding an authoritative conversion quote, exact payment amount, rounding, and validity window into the same seller-authorized attempt that owns settlement terms and the funding target.
