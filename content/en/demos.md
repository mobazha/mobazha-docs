---
title: Product demos
summary: Short, honest walkthroughs of real Mobazha flows — recorded from scripted runs against a running stack, narrated by on-screen chapter cards.
status: Draft
audiences:
  - Buyers
  - Sellers
...
**Cold-start Demand Capture** — how a new market serves buyer demand before
its catalog is deep. In planning.

## How these demos are made

Each demo is a scripted, re-recordable run of the real product — no mockups,
no spliced outcomes — and keeps its provenance: what was recorded, when, and
